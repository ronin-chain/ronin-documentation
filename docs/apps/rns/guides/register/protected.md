...
:::caution
As long as the owner doesn't sell or transfer their protected RNS name to another wallet, the name and its annual fee are protected. If the name is sold or transferred, it loses its _protected_ status.
:::
...
1. At the registration transaction, complete the following steps:
   ...
   1. Optionally, set this domain as your _primary name_ (2). If you do so, the domain will be displayed as your RNS name in all the RNS-enabled apps and wallets.
