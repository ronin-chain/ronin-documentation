...
1. The info page displays the renewal fee, domain tier, as well as other details. The RNS registrar requires two transactions to register a regular name: _request transaction_ and _registration transaction_. Click **Register now** to begin.
...
1. At the request transaction, complete the following steps:
   ...
   2. Optionally, set this domain as your _primary name_ (2). If you do so, the domain will be displayed as your RNS name in all the RNS-enabled apps and wallets.
      ![register](../../assets/regular/register.png)
1. Click **Request**, then confirm the request transaction.
