...
1. In the **Incentivize a pool** section, configure the farm rewards:
...
1. Click **Incentivize pool** to finish configuring your farm.
   ![Confirm pool incentive](../assets/katana-confirm-pool-incentive.png)
1. Click **Incentivise pool & Supply**, then confirm the transaction in your Ronin Wallet.
